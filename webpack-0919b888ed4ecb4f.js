!(function () {
    ...
    (d.m = a),
      ...
      (d.u = function (e) {
        return e + ".js"; // Ajustamos para que no añada paths extra
      }),
      (d.miniCssF = function (e) {
        return e + ".css"; // Si tienes CSS por chunks
      }),
      (d.o = function (e, t) {
      ...
      (d.l = function (e, t, n, u) {
        ...
        var i, c, f = document.getElementsByTagName("script");
      ...
      (d.p = "./"), // Aquí el cambio importante para rutas relativas
      (i = { 272: 0, 944: 0 }),
      (d.f.j = function (e, t) {
